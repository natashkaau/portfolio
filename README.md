...
| 12.| [Приоритизация гипотез по увеличению выручки в интернет-магазине — оценка результатов A/B теста](https://github.com/natashkaau/portfolio/blob/b4dc0ad1566d2480357361871fbfe022f99bea30/project_12/README.md) | Изучить данные и гипотезы, приоритизировать гипотезы при помощи фрейморков, провести анализ A/B-теста |SciPy, Python, Pandas, Matplotlib, NumPy, Seaborn|
